...
import { boxedLayoutMaxWidth } from "public/styles/variables";
...
const StyledDashboard = styled.div`
  ...
  /* theme */
  ${(props) =>
    props.theme.sidebarBg && `background-color: ${props.theme.sidebarBg};`}
...
class App extends Component {
  ...
  render() {
    ...
    const userMenuProfile = this.props.intl.formatMessage(
      messages.HeaderUserMenuItemOne
    );
    const userMenuSignOut = this.props.intl.formatMessage(
      messages.HeaderUserMenuItemTwo
    );

    const sidebarmap = (menu) =>
      menu.map((item, index) => {
          ...
          <StyledDashboard>
            <ThemeProvider theme={theme}>
              ...
              >
                ...
                <Header.UserMenu
                  name={authentication.user.email}
